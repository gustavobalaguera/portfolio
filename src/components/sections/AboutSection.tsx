          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            <div className="flex-1 space-y-6">
              <p className="text-lg text-foreground/90 leading-relaxed">
                I'm an E-commerce Systems & Security Analyst at <a href="https://riflessi.us/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">Riflessi</a> and a full-time cybersecurity student at <a href="https://www.stevens.edu/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">Stevens Institute of Technology</a> with hands-on experience in ethical hacking and penetration testing. My technical foundation is strengthened through training from the <a href="https://www.sans.org/about/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">SANS Institute</a> and recognition from the <a href="https://www.nationalcyberscholarship.org/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">National Cyber Scholarship Foundation</a>.

              </p>

              <p className="text-lg text-foreground/90 leading-relaxed">
                 I actively sharpen my offensive security skills through <a href="https://portswigger.net/web-security" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">PortSwigger Web Security Academy</a>, CTF competitions like <a href="https://picoctf.org/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80 transition-colors">PicoCTF</a>, and real-world bug bounty testing. These efforts have led to identifying and reporting multiple SQL injection vulnerabilities in production environments.
              </p>
